...
//int calforce(vector<ZG_Points>& a, double epsilon, double sigma, double step){
...
int main() {
    ...
    const string input_filename = R"(D:\桌面\HW1\Q2LennardjonesForce_powered_by_Zhi_Gong\1.txt)";
    const string output_filename = R"(D:\桌面\HW1\Q2LennardjonesForce_powered_by_Zhi_Gong\output1.txt)";
